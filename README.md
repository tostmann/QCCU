...
**Ein Schritt statt zwei (2026.8.21).** Die Erweiterung bringt die Integration **Homematic(IP) Local** mit und legt sie beim Start bereit — installieren, Home Assistant einmal neu starten, fertig; HACS ist dafür nicht mehr nötig. Mitgeliefert wird sie unverändert (MIT, Lizenz liegt bei) in der Fassung, gegen die geprüft wurde. Wer sie über HACS pflegt, behält sie: eine dort installierte neuere Fassung wird nie überschrieben, und abschalten lässt sich das Mitliefern in den Optionen. Im reinen Docker-Betrieb — etwa für FHEM — passiert von selbst nichts: QCCU fasst nur an, was ihm gezeigt wird.

**Die Oberfläche sagt jetzt, was los ist (2026.8.19).** Die Geräteliste führt den vergebenen Namen, wann das Gerät zuletzt gehört wurde und mit welchem Pegel; wer gerade angelernt werden will, steht im **Posteingang**; und unter **Zuletzt geschehen** stehen die Vorgänge, die man sonst im Protokoll suchen musste — angelernt, entfernt (mit der Auskunft, ob das Gerät den Funk-Ausschluss quittiert hat), Stick verloren und wiedergefunden. Fehlermeldungen des Dienstes erscheinen außerdem in der Seite, statt zu verschwinden.
